...
public class AES {
    ...
    public static String aesEncryptString(String data, String key) throws Exception {
    ...
    public static String aesDecryptString(String data, String key) throws Exception {
